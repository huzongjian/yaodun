...
import com.springmvc.relationdrug.rules.service.DosageCheckService;
 ...
 * 用量检测
 */
@Component("dosageChecker")
@Transactional
@Service
public class DosageChecker implements RuleChecker {

	@Resource
	private DosageCheckService dosageCheckService;
	...
	public List<ReportDetail> check(PatientInfo patientInfo,
		...
		return dosageCheckService.check(patientInfo, cellList);
	}
