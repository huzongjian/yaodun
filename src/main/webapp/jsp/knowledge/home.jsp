...
<script
	src="/yaodun/resources/bootstrap-wysiwyg/external/jquery.hotkeys.js"></script>
<link
	href="/yaodun/resources/bootstrap-wysiwyg/bootstrap-responsive.min.css"
	rel="stylesheet" />
<link
	href="/yaodun/resources/bootstrap-wysiwyg/bootstrap-combined.no-icons.min.css"
	rel="stylesheet" />
<link href="/yaodun/resources/bootstrap-wysiwyg/toolbar.css"
	rel="stylesheet" />
			...
			<div class="row">
				...
				<div class="span6">
					<div class="box-body bg-white">
						...
						<button id="update-imgPath" class="btn btn-default"
							data-method="updateimg">更新图片域</button>

						<button id="delete-data" class="btn btn-default"
							data-method="delete">删除数据</button>
						...
						<form id="sign-in">
							...
							<div class="control-group">
								<label class="control-label">图片</label> <span
									...
									class="icon-plus icon-white"></i> <span>选择上传图片png 89*89</span>
...
//更新图片域
		$('#update-imgPath').click(function() {
			  $.ajax({
				  type: 'POST',
				  url: "/yaodun/Knowledge/updateImg",
				  dataType: "json",
