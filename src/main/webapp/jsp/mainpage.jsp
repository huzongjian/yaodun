                    ...
                    <div class="span5 offset1" id ="t">
                        <div class="box corner-all">
                            ...
                            <div class="box-body bg-white">
                                <form id="sign-in" method="post" action="/drug_Testing/User/Login">
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
             ...
             /*    var location = (window.location+'').split('/');  
            	...
            	$.backstretch([basePath+"/resources/img/mainpagebg/5.jpg",
            			        basePath+"/resources/img/mainpagebg/1.jpg",
            			        basePath+"/resources/img/mainpagebg/2.jpg",
            			        basePath+"/resources/img/mainpagebg/3.jpg",
            			        basePath+"/resources/img/mainpagebg/4.jpg"
            			        ], {
            			          fade: 750,
            			          duration: 4000
            			    }); */
